...
type PDFService interface {
	...
	GenerateCancellationReceipt(payment *model.Payment, loan *model.Loan, client *model.Client, pendingCapital, accruedInterest, accruedIVA, total string) (io.Reader, error)
